...
{
	DepositTransaction* depositAmount = dynamic_cast<DepositTransaction*>(trans);
...
bool Account::Transfer(Transaction *& const trans, Account& accountToTransfer)
{
	...
	TransferTransaction* transferAmount = dynamic_cast<TransferTransaction*>(trans); //dynamically cast to it's child class
